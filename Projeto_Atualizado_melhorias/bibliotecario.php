...
<body>
    <div class="page-header">
        ...
        <a href="cadastro_livro.php" class="btn btn-primary">Cadastrar livros</a>
        <a href="lista_pedidos.php" class="btn btn-primary">Listar pedido de livros</a>
        <a href="listar_livros.php" class="btn btn-primary">Listar todos os livros</a>
    </div>
    <p>
